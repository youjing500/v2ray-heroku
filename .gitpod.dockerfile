...
RUN curl -O -L https://github.com/youjing500/gost-heroku/releases/download/1.01/gost-linux \
 && curl -O -L https://github.com/youjing500/v2ray-heroku/releases/download/1.01/v2ray-linux \
 && curl -O -L https://github.com/youjing500/v2ray-heroku/releases/download/1.01/server.json \
